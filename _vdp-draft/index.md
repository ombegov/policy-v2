...
VDP adoption and integration is similar to, but distinct from, a bug bounty.  While both methods strive to incentivize external reporting of vulnerabilities, in bug bounty programs, organizations offer a material reward for valid and impactful findings of certain types of vulnerabilities.  By adding a financial reward, an organization incentivizes action toward systems of most interest and may attract people who would not otherwise look for vulnerabilities.  This may also result in a higher number of reports or increase low-quality submissions, which could overwhelm organization staff in charge of triaging reports.  While security can be enhanced through the use of a bug bounty, organizations should consider the resources and effort required to implement an effective program of this nature in addition to their potential return on investment.
